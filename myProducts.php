                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4 mt-1 mb-1 text-center">
                                ...
                                if($profile_img_num==1){
                                    ...
                                    ?>
                                    <img src="images/new_user.svg" width="90px" height="90px" class="rounded-circle" />
                                    <?php
                                }
                                ?>
                            ...
                            <div class="col-12 col-lg-8">
                                <div class="row text-center text-lg-start">
                                    <div class="col-12 mt-0 mt-lg-4">
                                        <span class="text-white fw-bold">Ridmi Sansala</span>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 text-center mt-3 mb-3">
                                        <div class="row g-2">
                                            <div class="col-12 col-lg-6 d-grid">
                                                <button class="btn btn-success fw-bold" onclick="short1();">Sort</button>
                                            </div>
                                            <div class="col-12 col-lg-6 d-grid">
                                                <button class="btn btn-primary fw-bold" onclick="clearShort();">Clear</button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row" id="sort">
                            ...
                            <div class="offset-1 col-10 text-center">
                                <div class="row justify-content-center">
                                    ...
                                    $selected_rs = Database::search("SELECT * FROM `product` LIMIT 
                                    $result_per_page OFFSET $page_result");
